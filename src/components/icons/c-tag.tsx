export function CTagIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
    <svg
    ...
    >
      ...
      <path
        fill='currentColor'
        d='M512 448a64 64 0 1 0 0-128a64 64 0 0 0 0 128m0 64a128 128 0 1 1 0-256a128 128 0 0 1 0 256'
      />
    </svg>
  );
}
